...
import co.uk.fostorial.quest.data.db.QuestDao
import co.uk.fostorial.quest.data.db.QuestListDao
...
class QuestRepository(
    ...
    suspend fun getAllListsOnce(): List<QuestList> = questListDao.getAllListsOnce()
    ...
    suspend fun deleteAllQuestsInList(listId: Long) = questDao.deleteAllQuestsInList(listId)
}
