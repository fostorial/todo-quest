...
import co.uk.fostorial.quest.MainActivity
import co.uk.fostorial.quest.R
...
object QuestNotificationManager {
    ...
    const val QUEST_GROUP_KEY = "co.uk.fostorial.quest.QUEST_GROUP"
    ...
    fun showQuestReminderNotification(
        ...
        val completeIntent = Intent(context, NotificationReceiver::class.java).apply {
            action = "co.uk.fostorial.quest.ACTION_COMPLETE_QUEST"
